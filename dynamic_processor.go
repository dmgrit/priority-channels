...
func (p *DynamicPriorityProcessor[T]) RecoverClosedInnerPriorityChannel(channelName string, ctx context.Context) {
	p.priorityChannel.RecoverClosedInnerPriorityChannel(channelName, ctx)
}
